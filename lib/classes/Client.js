...
class Client extends discord_js_1.Client {
    ...
    registerCommand(dir, category) {
        ...
        try {
            ...
            else if (((_a = Command === null || Command === void 0 ? void 0 : Command.default) === null || _a === void 0 ? void 0 : _a.prototype) instanceof BaseCommand_1.default) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const file of files) {
                if (file.endsWith('.js')) {
                    ...
                    else if (((_e = Event === null || Event === void 0 ? void 0 : Event.default) === null || _e === void 0 ? void 0 : _e.prototype) instanceof BaseEvent_1.default) {
                        const instance = new Event.default();
                        instance.run = instance.run.bind(instance, this);
                        (_f = target.on) === null || _f === void 0 ? void 0 : _f.call(target, instance.name, instance.run);
                        (_h = (_g = target.events) === null || _g === void 0 ? void 0 : _g.set) === null || _h === void 0 ? void 0 : _h.call(_g, instance.name, instance);
                        if (this.debug)
                            this.log.debug(`Loaded ${defaultTarget ? 'Client' : (_j = target.constructor.name) !== null && _j !== void 0 ? _j : ''} Event - ${instance.name}`);
                    }
                }
            }
        });
