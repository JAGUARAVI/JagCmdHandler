            ...
            for (const file of files) {
                if (file.endsWith('.js')) {
                    ...
                    if (Event.prototype instanceof BaseEvent_1.default) {
                        ...
                        (_a = target.events) === null || _a === void 0 ? void 0 : _a.set(instance.name, instance);
                        if (this.debug)
                            this.log.debug(`Loaded ${defaultTarget ? 'Client' : (_b = target.constructor.name) !== null && _b !== void 0 ? _b : ''} Event - ${instance.name}`);
                    }
                }
            }
        });
